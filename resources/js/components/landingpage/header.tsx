                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        {auth.user?.role === 'admin' ? (
                            ...
                            <>
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-sm leading-normal text-white hover:border-white/20 transition-colors"
                                    onClick={toggleMenu}>
                                    Sign in
                                </Link>
                                <Link
