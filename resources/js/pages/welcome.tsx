            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  <Link
                    href={route('register')} // Ensure route('register') is defined
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex -space-x-2">
                      {[
                        { src: '/assets/Student1.png', alt: 'A' },
                        { src: '/assets/student2.png', alt: 'B' },
                        { src: '/assets/student3.png', alt: 'C' },
                        { src: '/assets/student4.png', alt: 'D' },
                      ].map(({ src, alt }) => (
                        <div
                          key={alt}
              ...
              <div className="relative lg:ml-24">
                <div className="relative z-10">
                  ...
                  <div className="aspect-[3/4] max-w-[400px] max-h-[520px] bg-gradient-to-br from-[#F88F60] to-[#e77d4d] rounded-2xl flex items-center justify-center overflow-hidden">
                    <img
                      src="/assets/Educator.png" // Replace with your image URL/path
